...
import (
	...
	route "knative.dev/serving/pkg/client/injection/informers/serving/v1/route"
)

const (
	defaultControllerAgentName = "route-controller"
	defaultFinalizerName       = "routes.serving.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	if len(optionsFns) > 1 {
		logger.Fatalf("up to one options function is supported, found ", len(optionsFns))
	}
