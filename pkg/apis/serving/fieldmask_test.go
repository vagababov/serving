...
func TestVolumeMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		t.Errorf("Got error comparing output, err = ", err)
	} else if diff != "" {
		t.Errorf("VolumeMask (-want, +got): ", diff)
	}
...
func TestVolumeSourceMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("VolumeSourceMask (-want, +got): ", diff)
	}
...
func TestPodSpecMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("PodSpecMask (-want, +got): ", diff)
	}
...
func TestContainerMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ContainerMask (-want, +got): ", diff)
	}
...
func TestVolumeMountMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("VolumeMountMask (-want, +got): ", diff)
	}
...
func TestProbeMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ProbeMask (-want, +got): ", diff)
	}
...
func TestHandlerMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("HandlerMask (-want, +got): ", diff)
	}
...
func TestExecActionMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ExecActionMask (-want, +got): ", diff)
	}
...
func TestHTTPGetActionMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("HTTPGetActionMask (-want, +got): ", diff)
	}
...
func TestTCPSocketActionMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("TCPSocketActionMask (-want, +got): ", diff)
	}
...
func TestContainerPortMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ContainerPortMask (-want, +got): ", diff)
	}
...
func TestEnvVarMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("EnvVarMask (-want, +got): ", diff)
	}
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			if diff, err := kmp.SafeDiff(test.want, got); err != nil {
				...
				t.Errorf("EnvVarSourceMask (-want, +got): ", diff)
			}
...
func TestLocalObjectReferenceMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("LocalObjectReferenceMask (-want, +got): ", diff)
	}
...
func TestConfigMapKeySelectorMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ConfigMapKeySelectorMask (-want, +got): ", diff)
	}
...
func TestSecretKeySelectorMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("SecretKeySelectorMask (-want, +got): ", diff)
	}
...
func TestConfigMapEnvSourceMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ConfigMapEnvSourceMask (-want, +got): ", diff)
	}
...
func TestSecretEnvSourceMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("SecretEnvSourceMask (-want, +got): ", diff)
	}
...
func TestEnvFromSourceMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("EnvFromSourceMask (-want, +got): ", diff)
	}
...
func TestResourceRequirementsMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("ResourceRequirementsMask (-want, +got): ", diff)
	}
...
func TestPodSecurityContextMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("PostSecurityContextMask (-want, +got): ", diff)
	}
...
func TestSecurityContextMask(t *testing.T) {
	...
	if diff, err := kmp.SafeDiff(want, got); err != nil {
		...
		t.Errorf("SecurityContextMask (-want, +got): ", diff)
	}
