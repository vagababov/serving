...
func TestGeneration(t *testing.T) {
	...
	if a := r.GetGeneration(); a != 0 {
		t.Errorf("empty pa generation should be 0 was: ", a)
	}
...
func TestMarkResourceNotOwned(t *testing.T) {
	...
	if active.Status != corev1.ConditionFalse {
		t.Errorf("TestMarkResourceNotOwned expected active.Status: False got: ", active.Status)
	}
	if active.Reason != "NotOwned" {
		t.Errorf("TestMarkResourceNotOwned expected active.Reason: NotOwned got: ", active.Reason)
	}
}
...
func TestMarkResourceFailedCreation(t *testing.T) {
	...
	if active.Status != corev1.ConditionFalse {
		t.Errorf("TestMarkResourceFailedCreation expected active.Status: False got: ", active.Status)
	}
	if active.Reason != "FailedCreate" {
		t.Errorf("TestMarkResourceFailedCreation expected active.Reason: FailedCreate got: ", active.Reason)
	}
}
